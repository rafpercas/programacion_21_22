...
public class Texto {
  ...
  public void introducirCaracter(char caracter, String pos){
      ...
      System.out.println("El caracter no cabe en la cadena, o ha introducido una posición errónea.");
      }
  }
  public void introducirCadena(String nuevaCadena, String pos){
        if(cadena.length()+nuevaCadena.length()<=limite && pos.equalsIgnoreCase("final")){
          cadena+=nuevaCadena;
        }else if(cadena.length()+nuevaCadena.length()<=limite && pos.equalsIgnoreCase("principio")){
