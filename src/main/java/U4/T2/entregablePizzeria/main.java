...
//
// La pizzería únicamente sirve Pizza de las que guardaremos el tamaño (size) que podrá ser (mediana
...
//
// La pizzería guarda todos los Pedido que se le realizan. Los pedidos únicamente contendrán una
...
public class main {
    public static void main(String[] args) {
        System.out.println(Pizza.maxIngredien);
        Pizza p2 = new Pizza();
        System.out.println(p2.maxIngredientes);
