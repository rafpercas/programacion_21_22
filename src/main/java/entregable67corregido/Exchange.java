...
public class Exchange implements Serializable{
    ...
    public void guardarCotizaciones() {
        try (ObjectOutputStream flujo_salida =
                     new ObjectOutputStream(new FileOutputStream("src/main/java/entregable67corregido/cotizaciones.dat"))) {
    ...
    public void recuperarCotizaciones() {
        try (ObjectInputStream flujo_entrada =
                     new ObjectInputStream(new FileInputStream("src/main/java/entregable67corregido/cotizaciones.dat"))) {
